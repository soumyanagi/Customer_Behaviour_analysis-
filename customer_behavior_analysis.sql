...
--what is the total revenue generated by male VS. femal customers?
SELECT gender, SUM(purchase_amount) AS revenue
FROM customer
GROUP BY gender

--which customer used a discount but still spend more than the average purchase_amount?
...
--are customers who are repeat buyers (more than 5 previous purchases) also likely too subscribe?
SELECT subscription_status,
